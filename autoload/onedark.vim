...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#e06C75", "cterm": "1", "cterm16": "1" }),
      \ "dark_red": get(s:overrides, "dark_red", { "gui": "#BE5046", "cterm": "196", "cterm16": "9" }),
      \ "green": get(s:overrides, "green", { "gui": "#98C379", "cterm": "114", "cterm16": "2" }),
      \ "yellow": get(s:overrides, "yellow", { "gui": "#E5C07B", "cterm": "166", "cterm16": "3" }),
      \ "dark_yellow": get(s:overrides, "dark_yellow", { "gui": "#D19a66", "cterm": "172", "cterm16": "11" }),
      ...
      \ "black": get(s:overrides, "black", { "gui": "#242C34", "cterm": "16", "cterm16": "0" }),
